...
INSERT INTO `dev_skills` VALUES (6,1,1);
...
INSERT INTO `developers` VALUES (1,'Tim','Lans');
...
INSERT INTO `skills` VALUES (1,'Java'),(2,'Git');
...
INSERT INTO `team_dev` VALUES (1,1,1);
...
CREATE TABLE `teams` (
  ...
  `status` enum('ACTIVE','UNDER_REVIEW','DELETED') DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `teams` VALUES (1,'DreamTeam','ACTIVE');
...
-- Dump completed on 2021-04-09 16:21:51
